...
export default function DwadashamshaPlanetTable({ d12 }) {
    if (!d12 || !d12.planets) return null;

    const planets = d12.planets;
                ...
                <table className="w-full border-2 border-black text-sm">
                    <thead className="bg-gray-100">
                        <tr>
                            ...
                            <th className="px-4 py-2">अंश (D12)</th>
