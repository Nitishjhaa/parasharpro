...
export default function D24PlanetTable({ d24 }) {
    if (!d24 || !d24.planets) return null;

    const planets = d24.planets;
        ...
        <div className="w-full p-1.5">
            <div className="w-full py-10">
                <h2 className="mb-3 text-2xl text-center">
                    चतुर्विंशांश (सिद्धांश) ग्रह तालिका (D24)
                </h2>
                ...
                <table className="w-full border-2 border-black text-sm">
                    <thead className="bg-gray-100">
                        <tr>
                            ...
                            <th className="px-4 py-2">अंश (Siddhamsha)</th>
