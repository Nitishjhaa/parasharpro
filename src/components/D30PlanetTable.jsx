...
export default function D30PlanetTable({ d30 }) {

    if (!d30 || !d30.planets) return null;

    const planets = d30.planets;
                ...
                <table className="w-full border-2 border-black text-sm">
                    ...
                    <thead className="bg-gray-100">
                        <tr>
                            ...
                            <th className="px-4 py-2">अंश (D30)</th>
