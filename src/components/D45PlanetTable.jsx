...
export default function D45PlanetTable({ d45 }) {

    if (!d45 || !d45.planets) return null;

    const planets = d45.planets;
                ...
                <table className="w-full border-2 border-black text-sm">
                    ...
                    <thead className="bg-gray-100">
                        <tr>
                            ...
                            <th className="px-4 py-2">अंश (D45)</th>
