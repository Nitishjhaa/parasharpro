...
export default function DrekkanaPlanetTable({ d3 }) {
    if (!d3 || !d3.planets) return null;

    const planets = d3.planets;
                ...
                <table className="w-full border-2 border-black text-sm">
                    <thead className="bg-gray-100">
                        <tr>
                            ...
                            <th className="px-4 py-2">अंश (Drekkana)</th>
